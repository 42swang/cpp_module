...
/*   Updated: 2022/03/01 20:01:34 by swang            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ScavTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << C_PRPL << "<" << _name << "> take " << amount << " damage... " << C_NRML;
	if (this->_hitpoint <= amount)
		this->_hitpoint = 0;
	else
		this->_hitpoint -= amount;
	std::cout << C_PRPL << "<" << _name << ">\'s HP is " << _hitpoint << " point\n" << C_NRML;
}

void	ScavTrap::beRepaired(unsigned int amount)
{
	this->_hitpoint += amount;
	std::cout << C_PRPL << "<" << _name << "> " << amount << " point repaired. <" << _name << ">\'s HP is " << _hitpoint << " point\n" << C_NRML;
}
